...
- The Obsidian board view now has a filter input in its header that
  narrows visible cards to tickets whose id, title, priority,
  project, stage, or agent status matches the query
  (case-insensitive, multi-word). The query is persisted per board
